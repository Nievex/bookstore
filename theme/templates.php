...
<head>
    ...
    <title><?php echo $title; ?> | BCP Online Bookstore</title>
...
<body style="background-color:white" onload="totalprice()">
    ...
    <div class="navbar-fixed-top navbar-TOPsm col-md-10 col-md-offset-1" role="navigation"
        style="background-color:darkblue; color:darkblue; padding: 1rem 0;">
        <div class="container">
            ...
            <div class="collapse navbar-collapse  smMenu">
                ...
                <ul class="navbar-nav p navbar-left tooltip-demo" style="margin-left:-5%;">
                    <li class="dropdown dropdown-toggle" style="margin-right: 16px;">
                        <a data-toggle="tooltip" data-placement="left" title="Contact Us"
                            href="<?php echo web_root.'index.php?q=contact';  ?>">
                            <i class="fa fa-phone fa-fw"> </i> 09126491106
                        </a>
                    </li>
                    <li class="dropdown dropdown-toggle">
                        <a data-toggle="tooltip" data-placement="right" title="Cart List"
                            href="<?php echo web_root.'index.php?q=cart';  ?>">
...
?>
    ...
    <div class="navbar navbar-static-top navbar-magbanua col-md-10 col-md-offset-1" role="navigation"
        style="background-color:darkblue;color:darkblue">
  ...
  ?>
            <div class="collapse navbar-collapse bigMenu">
                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="dropdown dropdown-toggle <?php echo ($q == '') ? 'active' : ''; ?>">
                        <a href="<?php echo web_root.'index.php'; ?>"> Home</a>
                    </li>
                    <li class="dropdown-toggle <?php echo ($q == 'contact') ? 'active' : ''; ?>">
                        <a href="<?php echo web_root.'index.php?q=contact'; ?>"> Contact Us</a>
                    </li>
                    <li class="dropdown-toggle <?php echo ($q == 'product') ? 'active' : ''; ?>">
                        <a href="<?php echo web_root.'index.php?q=product'; ?>"> Books</a>
                    </li>
                    <li class="dropdown-toggle <?php echo ($q == 'cart') ? 'active' : ''; ?>">
...
?>
            ...
            <footer class="panel-footer" style="background-color:darkblue;color:white">
                <p align="center">&copy; BCP Online Bookstore</p>
            </footer>
        </div>
