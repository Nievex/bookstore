  ...
  foreach ($cur as $result) { 
   ...
   ?>
     ...
     <div style="float:left; width:320px; margin-left:10px; "
         style="display: grid; grid-template-column: repeat(2, 1fr); gap: 4rem;">

         <div style="float:left; width:70px; margin-bottom:10px;">
             <a href="#" class="PHOTO" data-target="#photoModal" data-toggle="modal"
                 data-id="<?php  echo $result->PROID; ?>"> <img class="img-hover "
                     src="<?php  echo web_root.'admin/products/'. $result->IMAGES; ?>" width="150px" height="200px"
                     style="-webkit-border-radius:5px; -moz-border-radius:5px;" /></a>
         </div>
             ...
             <form method="POST" action="cart/controller.php?action=add">
                 ...
                 <p>
                     <b><?php  echo    $result->PRODESC; ?> <br />
                         ...
                         Stock: <?php  echo $result->PROQTY; ?><br />
                     </b>
                 </p>
