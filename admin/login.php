            ...
            <div class="col-md-4">
                ...
                <section class="login-form">
                    <form method="post" action="" role="login">
                        <img src="../img/adminlogo.jpg" class="img-responsive" alt="" />
                        <!--   <img src="../images/kcclogo.jpg" height="25px" class="img-responsive" alt="" /> -->
                        <?php echo check_message(); ?>
                        <input type="input" name="user_email" placeholder="Username" required
                            class="form-control input-lg" value="" />

                        <input type="password" name="user_pass" class="form-control input-lg" id="password"
