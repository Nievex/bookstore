    ...
    <div class="table-responsive">
        <table id="dash-table" class="table table-striped table-bordered table-hover " style="font-size:12px"
            ...
            <thead>
                <tr>
                    <!-- <th>Model</th>  -->
                    <!-- <th align="left"><input type="checkbox" name="chkall" id="chkall" onclick="return checkall('selector[]');"> Foods</th>  -->
                    <th>Books</th>
                    <!-- <th>Description</th> -->
                    <th>Category</th>
                    <th>Price</th>
            ...
            <tbody>
                <?php 
						...
						foreach ($cur as $result) { 
				  		...
				  		echo
				  		 '<td>
							<a href="'.web_root.'admin/settings/controller.php?action=editStatus&id='.$result->PROID.'&stats='.$stats.'" class="btn btn-primary btn-xs" style="width: 100%;">'.$stats.'</a>
				  		 </td>';
				  	} 
				  	?>
            </tbody>
