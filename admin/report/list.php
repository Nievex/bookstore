    ...
    <form action="index.php" method="post">
        ...
        <div class="col-lg-4">
            <div class="col-md-16">
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group input-group" style="margin: 0 2rem 0 0;">
                            <label>From::</label>
                            <div style="display: flex; align-items: center; gap: 1rem;">
                                <input type="text" data-date="" data-date-format="yyyy-mm-dd" data-link-field="any"
                                    data-link-format="yyyy-mm-dd" name="date_pickerfrom" id="date_pickerfrom"
                    ...
                    <div class="col-md-6">
                        <div class="form-group input-group" style="margin: 0 2rem 0 0;">
                            ...
                            <div style="display: flex; align-items: center; gap: 1rem;">
                                <input type="text" data-date="" data-date-format="yyyy-mm-dd" data-link-field="any"
                                    data-link-format="yyyy-mm-dd" name="date_pickerto" id="date_pickerto"
    ...
    <span id="printout">
        <div class="col-md-12">
            <div class="page-header" style="text-align:center;">
                <h1>List of Ordered Books</h1>
                <div>Inclusive Dates: From :
...
function tablePrint() {
    ...
    document_print.document.write('<body style="font-family:Calibri(body);  font-size:8px;" onLoad="self.close();" >');
