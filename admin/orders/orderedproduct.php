...
// 							# code...
// 	$status	= 'Confirmed';	
// 	// $remarks ='Your order has been confirmed. The ordered Food will be yours in the exact date and time that you have set.';
...
<div class="modal-content">
	<div class="modal-header">
		...
		<!-- <h2 class="modal-title" id="myModalLabel"><strong>List of Ordered foods</strong></h2> -->
