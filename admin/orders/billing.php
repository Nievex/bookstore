...
<div class="container"> 
  ...
  <span id="printout">
  <h3 align="center">Notre Dame E-Canteen</h3>
      <h4 align="center">
      </h4>
          ...
          <tbody>
            ...
            <tr>
              ...
              <div class="row" style="margin-left:2%"> 
                <p>We hope you enjoy your purchased Food. Have a nice day!</p>
                <p>Sincerely.</p>
                <h4></h4>
            </div>
...
function tablePrint(){ 
 document.all.divButtons.style.visibility = 'hidden';  
    ...
    document_print.document.write('<body style="font-family:verdana; font-size:12px;" onLoad="self.close();" >');  
