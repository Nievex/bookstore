  ...
  <div class="modal-content">
	<div class="modal-header">
		...
		<table>
			<tr>
				<td align="center"> 
				<img src="<?php echo web_root; ?>img/logo2.png"  height="90px" style="-webkit-border-radius:5px; -moz-border-radius:5px;" alt="Image">
        		</td>
				<td width="87%" align="center">
				<h3 >Bachelor of Science and Entrepreneurs</h3>
				<!-- <h4 >Block 5 AR Zayco Subdivision<br/>
				Kabankalan City<br/>
				</h4> -->
				</td>
			</tr>
		...
		?>
 		...
 		<div class="row">
		  ...
		  <div class="row">
		  	  ...
		  	  <p>Sincerely.</p>
		  	  <h4>Bachelor of Science and Entrepreneurs</h4>
		  </div>
		  <?php }?>
  </div> 
