                         ...
                         <div class="tab-pane fade in active" id="home">
                             ...
                             <div class="panel panel-primary">
                                     ...
                                     <form class="form-horizontal span6" name="" action="login.php" method="POST">
                                         ...
                                         <div class="form-group">
                                             <div class="col-md-10">
                                                 ...
                                                 <div class="col-md-8">
                                                     <input id="U_USERNAME" name="U_USERNAME" placeholder="Username"
                                 ...
                                 <div class="panel-footer">
                                     <p align="left">&copy; BBS Company BCP Bookstore System</p>
                                 </div>
                             </div>
                         </div>
                         <!-- end login panel -->
                                 ...
                                 <div class="panel panel-primary">
                                     ...
                                     <div class="panel-body">
                                             ...
                                             <div class="col-md-10">
                                                 ...
                                                 <div class="col-md-8">
                                                     <input id="GENDER" name="GENDER" placeholder="Gender" type="radio"
                                                         checked="true" value="Male"><b> Male </b>
                                                     <input id="GENDER" name="GENDER" placeholder="Gender" type="radio"
                                         ...
                                         <div class="panel panel-primary">
                                             ...
                                             <div class="panel-body">
                                                 <div class="form-group">
                                                     <div class="col-md-10">
                                                         <label class="col-md-4 control-label" for="CUSHOMENUM">Home
                                                             Number:</label>

                                                         <div class="col-md-8">
                                                             <input class="form-control input-sm" id="CUSHOMENUM"
                                                                 name="CUSHOMENUM" placeholder="Home Number" type="text"
                                                                 value="">
                                                         </div>
                                                     </div>
                                                 </div>
                                                 ...
                                                 <div class="form-group">
                                                     <div class="col-md-10">
                                                         <label class="col-md-4 control-label" for="STREETADD">Street /
                                                             Barangay:</label>

                                                         <div class="col-md-8">
                                                             <input class="form-control input-sm" id="STREETADD"
                                                                 name="STREETADD" placeholder="STREET / Barangay"
                                                                 type="text" value="">
                                                         </div>
                                                     </div>
                                                 </div>
                                             ...
                                             <div class="form-group">
                                                 <div class="col-md-10">
                                                     <label class="col-md-4 control-label"
                                                         for="CITYADD">Municipality/City:</label>

                                                     <div class="col-md-8">
                                                         <input class="form-control input-sm" id="CITYADD"
                                                             name="CITYADD" placeholder="Municipality/City Address"
                                                             type="text" value="">
                                                     </div>
                                                 </div>
                                             </div>
                                                 ...
                                                 <div class="col-md-10">
                                                     ...
                                                     <div class="col-md-8">
                                                         <input class="form-control input-sm" id="PROVINCE"
                                                             name="PROVINCE" placeholder="Province" type="text"
                                                             value="">
                                                     </div>
                                                 </div>
                                             </div>
                                             ...
                                             <div class="form-group">
                                                 <div class="col-md-10">
                                                     ...
                                                     <div class="col-md-8">
                                                         <input class="form-control input-sm" id="COUNTRY"
                                         ...
                                         <div class="col-md-10">
                                             ...
                                             <div class="col-md-8">
                                                 <input class="form-control input-sm" id="ZIPCODE" name="ZIPCODE"
                                                     placeholder="Zip Code" type="number" value="">
                                             </div>
                                         </div>
                                     </div>
                                     ...
                                     <div class="form-group">
                                         <div class="col-md-10">
                                             ...
                                             <div class="col-md-8">
                                                 <p> I <input type="checkbox" id="conditionterms" name="conditionterms"
                                                         value="checkbox" />
                                                     <small>Agree with the <a class="toggle-modal"
                                                             onclick=" OpenPopupCenter('terms.php','Terms And Codition','600','600')"><b>TERMS
                                                                 AND CONDITION</b></a> of BBS Company BCP Bookstore
                                                         System.</small>
