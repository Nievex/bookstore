     ...
     <div class="col-lg-12" style="margin-top:5%;">
         <div class="row">
             ...
             <div class="col-lg-6">
                 <div class="form-group">
                     <div class="col-md-12">
                         <label class="col-md-4 control-label" for="CUSHOMENUM">Home#:</label>

                         <div class="col-md-8">
                             <input class="form-control input-sm" id="CUSHOMENUM" name="CUSHOMENUM"
                                 placeholder="Home Number" type="text" value="<?php echo $res->CUSHOMENUM; ?>">
                         </div>
                     </div>
                 </div>
             </div>
             <div class="col-lg-6">
                 ...
                 <div class="form-group">
                     <div class="col-md-12">
                         <label class="col-md-4 control-label" for="STREETADD">Street/Barangay:</label>

                         <div class="col-md-8">
                             <input class="form-control input-sm" id="STREETADD" name="STREETADD"
                                 placeholder="Street / Barangay" type="text" value="<?php echo $res->STREETADD; ?>">
                         </div>
                     </div>
                 </div>
             </div>
                     ...
                     <div class="col-md-12">
                         ...
                         <div class="col-md-8">
                             <input class="form-control input-sm" id="CITYADD" name="CITYADD"
                                 placeholder="Municipality/City Address" type="text"
                                 value="<?php echo $res->CITYADD; ?>">
                         </div>
                     </div>
                 </div>
             ...
             <div class="col-lg-6">
                 <div class="form-group">
                     <div class="col-md-12">
                         ...
                         <div class="col-md-8">
                             <input class="form-control input-sm" id="PROVINCE" name="PROVINCE" placeholder="Province"
                                 type="text" value="<?php echo $res->PROVINCE; ?>">
                         </div>
                     </div>
                 </div>
             </div>
             <div class="col-lg-6">
                 <div class="form-group">
                     <div class="col-md-12">
                         ...
                         <div class="col-md-8">
                             <input class="form-control input-sm" id="COUNTRY" name="COUNTRY" placeholder="Country"
                                 type="text" value="<?php echo $res->COUNTRY; ?>">
                         </div>
                     </div>
                 </div>
             </div>
             ...
             <div class="col-lg-6">
                 <div class="form-group">
                     <div class="col-md-12">
                         ...
                         <div class="col-md-8">
                             <input class="form-control input-sm" id="PHONE" name="PHONE" placeholder="Contact Number"
                                 type="text" value="<?php echo $res->PHONE; ?>">
                         </div>
                     </div>
                 </div>
             </div>
                     ...
                     <div class="col-md-12">
                         ...
                         <div class="col-md-8">
                             <input class="form-control input-sm" id="ZIPCODE" name="ZIPCODE" placeholder="Zip Code"
                                 type="number" value="<?php echo $res->ZIPCODE; ?>">
                         </div>
                     </div>
                 </div>
             </div>
