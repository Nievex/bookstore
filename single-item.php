...
<form method="POST" action="cart/controller.php?action=add">
    <div class="row">
        ...
        <div class="col-md-6" style="margin: 2rem 0 0 4rem;">
            <div class="row">
                <div class="col-m-8">
                    <div class="col-md-8 responsive">
                        <img width="360" class="img-portfolio"
        ...
        <div class="col-md-4" style="margin: 2rem 0 0 0;">
...
?>
    <div class="col-sm-3 col-xs-6">
        <a href="index.php?q=single-item&id=<?php echo $result->PROID; ?>">
            <img class="img-hover img-related" width="135px"
                src="<?php echo web_root.'admin/products/'.$result->IMAGES;?>" alt="" style="margin: 0 0 2rem 0;">
        </a><br />
